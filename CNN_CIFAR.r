...
untar("cifar-100-binary.tar.gz", exdir = ".")
# Download and transform the images from the CIFAR-100 database 
train_ds <- cifar100_dataset(root=".", train=TRUE, download=FALSE, transform=transform)
test_ds <- cifar100_dataset(root=".", train=FALSE, download=FALSE, transform=transform)
